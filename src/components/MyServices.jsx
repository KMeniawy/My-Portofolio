...
const MyServices = () => {
  ...
  return (
    <div className="2xl:h-[120vh] xl:h-[130vh] md:h-[145vh] bg-gradient-to-tr from-[#010010] to-[#010185] text-white 2xl:pt-24 md:pt-20" data-aos="fade-up" data-aos-delay="300">
      <div className="pb-16">
