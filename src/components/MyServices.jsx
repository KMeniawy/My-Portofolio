...
const MyServices = () => {
  ...
  return (
    <div className="2xl:h-[110vh] xl:h-[130vh] lg:h-[140vh] bg-gradient-to-tr from-[#010010] to-[#010185] text-white 2xl:pt-24 lg:pt-20" data-aos="fade-up" data-aos-delay="300">
      <div className="pb-16">
